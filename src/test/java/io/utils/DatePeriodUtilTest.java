...
class DatePeriodUtilTest {
    private static final DatePeriod BASE_PERIOD = new DatePeriod(LocalDate.of(2023, 01, 14),
            LocalDate.of(2023, 02, 05));

    private static final DatePeriod START_OVERLAP = new DatePeriod(LocalDate.of(2023, 01, 12),
            LocalDate.of(2023, 01, 16));
    private static final DatePeriod WHOLLY_IN_PERIOD = new DatePeriod(LocalDate.of(2023, 01, 15),
            LocalDate.of(2023, 02, 04));
    private static final DatePeriod END_OVERLAP = new DatePeriod(LocalDate.of(2023, 02, 04),
            LocalDate.of(2023, 02, 06));

    private static final DatePeriod SINGLE_DATE_PERIOD_START = new DatePeriod(LocalDate.of(2023, 01, 14),
            LocalDate.of(2023, 01, 14));
    private static final DatePeriod SINGLE_DATE_PERIOD_END = new DatePeriod(LocalDate.of(2023, 02, 05),
            LocalDate.of(2023, 02, 05));

    private static final DatePeriod OVERLAPPING_START_DAY = new DatePeriod(LocalDate.of(2023, 01, 13),
            LocalDate.of(2023, 01, 14));
    private static final DatePeriod OVERLAPPING_END_DAY = new DatePeriod(LocalDate.of(2023, 02, 05),
            LocalDate.of(2023, 02, 06));

    private static final DatePeriod PERIOD_BEFORE = new DatePeriod(LocalDate.of(2023, 01, 01),
            LocalDate.of(2023, 01, 13));
    private static final DatePeriod PERIOD_AFTER = new DatePeriod(LocalDate.of(2023, 02, 06),
